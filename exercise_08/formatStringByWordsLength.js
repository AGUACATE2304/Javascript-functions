...
/**
 *  Check if the given sentence is longer than the given number of words and change to lower case or upper case string
 * @param {string} sentence Given sentence to evaluate
